...
public class ScreenFormActivity extends MenuBar implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (form_id != 0) {
            ...
            specimentSent.setText(AppUtil.getLongValue(form.specimentSent));
            tbStatus.setText(AppUtil.getLongValue(form.tbStatus));
            smear.setText(AppUtil.getLongValue(form.smear));
            xpert.setText(AppUtil.getLongValue(form.xpert));
            others.setText(AppUtil.getLongValue(form.others));
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == btn_save.getId()) {
            if (validate()) {
                ...
                form.specimentSent = AppUtil.getLongValue(specimentSent.getText().toString());
                form.tbStatus = AppUtil.getLongValue(tbStatus.getText().toString());
                form.smear = AppUtil.getLongValue(smear.getText().toString());
                form.xpert = AppUtil.getLongValue(xpert.getText().toString());
                form.others = AppUtil.getLongValue(others.getText().toString());
